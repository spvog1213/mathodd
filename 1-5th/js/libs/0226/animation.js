...
var iconName = parent.window.iconName;
...
function incorrectAnimation(dragObj) {
	...
	if (gameManager.CURRENT_TYPE === 'click' || gameManager.CURRENT_TYPE === 'fraction_bti' || gameManager.CURRENT_TYPE === 'grapetree' || gameManager.CURRENT_TYPE === 'chocobox' || gameManager.CURRENT_TYPE === 'divide_selection' || gameManager.CURRENT_TYPE === 'train' || gameManager.CURRENT_TYPE === 'archery' || gameManager.CURRENT_TYPE === 'train2' || gameManager.CURRENT_TYPE === 'train5Row' || gameManager.CURRENT_TYPE === 'bead' || gameManager.CURRENT_TYPE === 'donut' || gameManager.CURRENT_TYPE === 'chocoplate' || gameManager.CURRENT_TYPE === 'candle' || gameManager.CURRENT_TYPE === 'beadRead' || gameManager.CURRENT_TYPE === 'dessert' || gameManager.CURRENT_TYPE === 'camping' || gameManager.CURRENT_TYPE === 'block' || gameManager.CURRENT_TYPE === 'picture' || gameManager.CURRENT_TYPE === 'basketball'|| gameManager.CURRENT_TYPE === 'colorpencilRibbon' ||  gameManager.CURRENT_TYPE === 'dogFoodTwo')
		currentTop = 100;

	if (gameManager.CURRENT_TYPE === 'scale' || gameManager.CURRENT_TYPE === 'mathToy' )
		currentTop = 20;

	if (gameManager.CURRENT_TYPE === 'piggyBank' || gameManager.CURRENT_TYPE === 'lotto' || gameManager.CURRENT_TYPE === 'lock' || gameManager.CURRENT_TYPE === 'pencil' || gameManager.CURRENT_TYPE === 'busstop' || gameManager.CURRENT_TYPE === 'puzzle' || gameManager.CURRENT_TYPE === 'ballon2' || gameManager.CURRENT_TYPE === 'fruitsBox' || gameManager.CURRENT_TYPE === 'animalFence'|| gameManager.CURRENT_TYPE === 'bus' || gameManager.CURRENT_TYPE === 'chocodivide' || gameManager.CURRENT_TYPE === 'seeSaw') {
	...
	if (gameManager.CURRENT_TYPE === 'robot1' || gameManager.CURRENT_TYPE === 'robot2' || gameManager.CURRENT_TYPE === 'dogFoodTwo') {
		var left = gameManager.choiceQuestionPosition[dragObjId[1]][1];
		currentLeft = 100;
	}

	if (gameManager.CURRENT_TYPE === 'dollshooting' || gameManager.CURRENT_TYPE === 'target') {
		var left = gameManager.choiceQuestionPosition[dragObjId[1]][1];
		currentLeft = 100;
	}
