function initScene() {
	...
	chocoCutArroWidthBox.setAttribute('style','position:absolute; top:100px; left:375px;');
	chocoCutArroWheightBox.setAttribute('style','position:absolute; top:236px; left:247px; z-index:10');
...
function chocoCutArroWidth(){
	...
	btnUp = function(e) {
		...
		chocodivideBox.setAttribute('style','position:absolute; top:160px; left:235px;');
			// carrot();
	...
	function chocoCutArroheight(){
		...
		for(var j = 0; j<3; j++){
			...
			appendImageElement('chocodivide_' + j,'images/chocodivide_5_1.png', chocodivideBox);
		...
		btnUp = function(e) {
			...
			chocodivideBox.setAttribute('style','position:absolute; top:125px; left:295px; width:100px;');
