function initScene() {
	...
	appendImageElement('numcardBg', 'images/vic_numcard1_questionbox.png',division,'numcardBg');


	appendImageElement('butterfly_textbox', 'images/numpad_' + randResult[1] + '.png',question1,'butterfly_textbox');
...
function inithangerBar() {
	...
	triangleAnswer.setAttribute('style','position:absolute; top:114px; left:707px; width:135px; height:135px;');

	question1.setAttribute('style','position:absolute; top:375px; left:122px; width:202px; z-index:10; font-size:50px;');
	question2.setAttribute('style','position:absolute; top:506px; left:397px; width:202px; z-index:10; font-size:50px;s');
	question3.setAttribute('style','position:absolute; top:375px; left:673px; width:202px; z-index:10;');
...
function appendSelectQuestion(buttonType, choiceQuestionArray, imgSrcArray) {
	...
	for (var i = 0; i < choiceQuestionArray.length; i++) {
		...
		if (imgSrcArray) {
			...
			appendImageElement('butterfly', 'images/numpad_' + randResult[0] + '.png', document.querySelector('#choiceQuestion_' + i));
