function initScene() {
	...
	circleAnswer.setAttribute('style', 'top: 88px; left: 876px;');
...
function archery() {
	...
	Question1.innerHTML = '<img src= images/archery_target_'+ fall +'.png>'
	Question2.innerHTML = '<img src= images/archery_downarrow_'+ hitshow +'.png>'
}	
...
function startBtn(dragObj) {
	...
	number2.setAttribute('style', 'left: 72%; top: 47.5%;');

	correct.setAttribute('id','correct');
	correct.setAttribute('style', 'left: 38.5%; top: 47.5%;');
