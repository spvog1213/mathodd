function initScene() {
	...
	chocoCutArroWidthBox.setAttribute('style','position:absolute; top:100px; left:293px;');
	chocoCutArroWheightBox.setAttribute('style','position:absolute; top:236px; left:165px; z-index:10');
...
function chocoCutArroWidth(){
	...
	for(var j = 0; j<7; j++){
		...
		appendImageElement('chocodivide_' + j,'images/chocodivide_1_3.png', chocodivideBox);
	...
	btnUp = function(e) {
		...
		chocodivideBox.setAttribute('style','position:absolute; top:160px; left:113px;');
			// carrot();
	...
	function chocoCutArroheight(){
		...
		for(var j = 0; j<3; j++){
			...
			appendImageElement('chocodivide_' + j,'images/chocodivide_7_1.png', chocodivideBox);
		...
		btnUp = function(e) {
			...
			chocodivideBox.setAttribute('style','position:absolute; top:125px; left:216px; width:100px;');
