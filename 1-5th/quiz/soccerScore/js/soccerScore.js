function initScene() {
	...
	circleAnswer.setAttribute('style', 'top:200px; left: 235px');
	triangleAnswer.setAttribute('style', 'top:200px; left: 780px');
	...
	currentAnswerText.setAttribute('style', 'position:absolute; left:62px; width:296px; text-align:center; z-index:10;');
	currentAnswerText.innerHTML = '<span>십의 자리 숫자</span>';
	...
	currentAnswerDimText.setAttribute('style', 'position:absolute; left:606px; width:297px; text-align:center;');
	currentAnswerDimText.innerHTML = '<span>일의 자리 숫자</span>';
}
