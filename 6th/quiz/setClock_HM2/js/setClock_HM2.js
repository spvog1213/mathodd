function initScene() {
	...
	quizClock.setAttribute('style', 'display:inline-block; width: 430px; height: 185px;	text-align: center;	color: #66532a;	background: url(images/digitalClock.png); margin-top:50px;')
	...
	checkBtn.setAttribute('style','position: absolute; top: 580px; left: 1100px; width: 98px; height: 106px; visibility:visible; background: url(../../images/common/checkBtnRed.png) no-repeat;');
	checkBtn_on.setAttribute('style','position: absolute; top: 580px; left: 1100px; width: 98px; height: 106px;  visibility:hidden; background: url(../../images/common/checkBtnRed_on.png) no-repeat;');
	clock ();
}
		...
		btnArray[i].addEventListener('click', function(e){
			...
			if (targetClass == 'plus') {
				...
				if (targetNeedle !== 'hour') {
					...
					} else if (clickArray[arrayIdx] == 0 || clickArray[arrayIdx] == 60) {
