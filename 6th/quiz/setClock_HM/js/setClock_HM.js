function initScene() {
	...
	quizClock.setAttribute('style', 'margin-top: 50px; width: 430px; height: 185px;	text-align: center;	color: #66532a; background: url(images/digitalClock.png); display:inline-block;')
...
function clock () {
	...
	for (var i = 0; i < btnArray.length; i++) {
		...
		if(gameManager.QUIZ_OPTION.length ===3 ){
			...
			deg = rotate(gameManager.QUIZ_OPTION[0]);
