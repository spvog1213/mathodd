	...
	var eventCheck = 'ontouchstart' in window || window.DocumentTouch && document instanceof DocumentTouch,
		...
		initSpinPicker: function (config) {
			config.slot.forEach(function (value, idx) {
				SALTGAMER.SpinPicker.addSlot(value.data, value.align, value.default);
			});
		...
		create: function () {
			...
			// Global events
			document.addEventListener(this.eventSelector.downEvent, this, false);			// Prevent page scrolling
			document.addEventListener(this.eventSelector.moveEvent, this, false);			// Prevent page scrolling
			window.addEventListener('orientationchange', this, true);		// Optimize SW on orientation change
			window.addEventListener('scroll', this, true);				// Reposition SW on page scroll

			// Cancel/Done buttons events
			document.getElementById('sw-cancel').addEventListener(this.eventSelector.downEvent, this, false);
			document.getElementById('sw-done').addEventListener(this.eventSelector.downEvent, this, false);

			// Add scrolling to the slots
			this.swFrame.addEventListener(this.eventSelector.downEvent, this, false);
		},
		...
		destroy: function () {
			...
			this.swFrame.removeEventListener(this.eventSelector.downEvent, this, false);

			document.getElementById('sw-cancel').removeEventListener(this.eventSelector.downEvent, this, false);
			document.getElementById('sw-done').removeEventListener(this.eventSelector.downEvent, this, false);
		...
		scrollStart: function (e) {
			...
			if (this.slotData[this.activeSlot].style.match('readonly')) {
				this.swFrame.removeEventListener(this.eventSelector.moveEvent, this, false);
				this.swFrame.removeEventListener(this.eventSelector.upEvent, this, false);
				return false;
			}
			...
			this.swFrame.addEventListener(this.eventSelector.moveEvent, this, false);
			this.swFrame.addEventListener(this.eventSelector.upEvent, this, false);
		...
		scrollMove: function (e) {
			...
			this.swFrame.addEventListener(this.eventSelector.outEvent, this, false);
		...
		scrollEnd: function (e) {
			...
			this.swFrame.removeEventListener(this.eventSelector.outEvent, this, false);
		...
		// Buttons
		tapDown: function (e) {
			e.currentTarget.addEventListener(this.eventSelector.moveEvent, this, false);
			e.currentTarget.addEventListener(this.eventSelector.upEvent, this, false);
			e.currentTarget.className = 'sw-pressed';
		},

		tapCancel: function (e) {
			e.currentTarget.removeEventListener(this.eventSelector.moveEvent, this, false);
			e.currentTarget.removeEventListener(this.eventSelector.upEvent, this, false);
